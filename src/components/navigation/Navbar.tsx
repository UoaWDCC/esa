...
export default function Navbar() {
    ...
    return (
        <>
            {/* Desktop Navbar */}
            <nav className="hidden md:flex z-50 fixed top-5 left-1/2 transform -translate-x-1/2 bg-primary-black font-roboto-mono text-[0.9rem] lg:text-[1rem] xl:text-[1.2rem] text-primary-white justify-between items-center bg-primary-grey-light w-[75%] lg:w-[80%] xl:w-[85%] 2xl:w-[90%] max-w-[800px] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1100px] px-6 lg:px-12 xl:px-18 2xl:px-28 rounded-full gap-1 md:gap-2 lg:gap-3 xl:gap-4 py-1">
