                ...
                <div className="flex items-center justify-center gap-11 py-9 px-10 rounded-[3.5em] md:rounded-[5em] bg-[#ebe9e6]">
                    ...
                    <div className="z-10 flex flex-col items-center gap-4">
                        <div className="relative">
                            {/* title */}
                            <Title className="bg-primary-red-400">Who are we?</Title>
                            {/* arrow */}
                            <Image
                        ...
                        {/* description */}
                        <p className="w-[88%] md:w-56 mb-4 font-medium text-center text-black text-base/tight bg">
                        ...
                        <div className="w-[80%] md:w-88">
                            <p className="self-start text-sm tracking-[0.15em] text-black mb-4">
                                We are one of the largest and most diverse social clubs on campus
                                and welcome anyone to join us!
                            </p>
                            <p className="self-start text-sm tracking-[0.15em] text-black">
                                We believe that university life is not just about academic
                                studies... but also having fun, and meeting new friends.
                            </p>
                        </div>
                    </div>
                </div>
